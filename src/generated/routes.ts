...
import { expressAuthentication } from './../infrastructure/middlewares/auth.middleware';
// @ts-ignore - no great way to install types from subpackage
import { iocContainer } from './../infrastructure/ioc/di-container';
    ...
    // ###########################################################################################################
        ...
        app.post('/users',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    userDto: {"in":"body","name":"userDto","required":true,"ref":"CreateUserDto"},
            };
        ...
        app.get('/users',
            ...
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.readMany)),

            async function UserController_readMany(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.post('/messages',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    ...
                    messageDto: {"in":"body","name":"messageDto","required":true,"ref":"CreateMessageDto"},
            };
        ...
        app.get('/messages',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(MessageController)),
            ...(fetchMiddlewares<RequestHandler>(MessageController.prototype.readMany)),

            async function MessageController_readMany(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
